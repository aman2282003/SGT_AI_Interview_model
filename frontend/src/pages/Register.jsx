...
export default function Register() {
  ...
  return (
    ...
    >
      ...
      <div className="max-w-md w-full space-y-8 bg-white dark:bg-gray-900 bg-opacity-70 dark:bg-opacity-40 backdrop-blur-2xl p-6 sm:p-10 rounded-[2rem] sm:rounded-[2.5rem] shadow-2xl dark:shadow-purple-500/20 border border-white/50 dark:border-white/10 relative z-10 transition-colors duration-300">
